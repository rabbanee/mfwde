    ...
    this.innerHTML = `
      <article class="restaurant-item" id="${this._restaurant.id}">
        <div class="wrapper-img">
          <img data-src="${CONFIG.BASE_URL_IMAGE}small/${this._restaurant.pictureId}" data-srcset="${CONFIG.BASE_URL_IMAGE}small/${this._restaurant.pictureId}" src="./images/placeholder-large.png" srcset="./images/placeholder-small.png 480w, ./images/placeholder-large.png 800w"
